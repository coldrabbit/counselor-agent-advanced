...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/', name: 'workbench', component: () => import('../pages/MonthlyWorkbench.vue'), meta: { auth: true } },
    { path: '/assistant', name: 'assistant', component: () => import('../pages/Home.vue'), meta: { auth: true } },
